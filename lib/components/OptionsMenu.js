...
function OptionsMenu() {
  const [removeCard, isRemovingCard] = useRemoveCard('');
  ...
  return (
    <div className="absolute rounded-xl h-40 w-44 bg-gray-100 dark:bg-zinc-800 p-2 flex flex-col justify-between">
      ...
      <div onClick={removeCard} className="flex dark:text-white bg-transparent hover:bg-gray-200 dark:bg-transparent dark:hover:bg-zinc-700 cursor-pointer w-full h-11 rounded-lg p-1 items-center px-4 space-x-3">
