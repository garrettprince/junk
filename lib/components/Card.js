...
function Card({
  ...
  const { color, backgroundColor } = colorData.find(
  ...
  // const backgroundColor = colorData.find(
  //   (c) => c.name === categoryColor
  // ).backgroundColor;
    ...
    >
      ...
      >
        ...
        <div className="flex-col ml-3 leading-4">
          ...
          <h2 className="flex text-xs font-extrabold" style={{ color }}>
            MIN
          </h2>
        </div>
      </section>
      <footer className="flex justify-between mx-4 mt-4 mb-1 content-center">
        <h2 className="text-sm font-extrabold" style={{ color }}>
